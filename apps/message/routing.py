...
from apps.message.consumers import issues_message, user_notice, comment_message, thumbup_message

websocket_urlpatterns = [
    # 动态通知，这里的user_id即是消息的源，即当前用户
    ...
    # 点赞通知，同上
    re_path(r'ws/system/thumbsup/(?P<user_id>\w+)/$', thumbup_message.ThumbUpMessage.as_asgi()),
]
