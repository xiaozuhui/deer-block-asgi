...
class ThumbUpMessage(MessageConsumer):
    """
    点赞的消息
    """
    ...
    async def receive(self, text_data=None, bytes_data=None):
        """
        点赞可能给issues点赞，也肯能给评论点赞
        所以其中的issues_id是必须的（后续如果文章出现，可能issuesid还要修改）
        但是comment相关信息不一定是必须的
        """
